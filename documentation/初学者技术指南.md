...
│   ├── openGLHelper/           # OpenGL 辅助
│   ├── performanceCounter/     # 性能计数器
│   ├── polarDecomposition/     # 极分解
│   ├── quaternion/             # 四元数
...
│   ├── sceneObject/            # 场景对象
│   ├── sceneObjectReduced/     # 降维场景对象
│   ├── shapeEdit/              # 形状编辑
│   ├── sparseMatrix/           # 稀疏矩阵
│   ├── sparseSolver/           # 稀疏求解器
│   ├── stencilForceModel/      # 模板力模型
